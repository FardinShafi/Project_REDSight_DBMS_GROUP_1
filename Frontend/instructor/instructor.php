...
<div class="sidebar">
  ...
  <div class="ag-format-container">
    <div class="ag-courses_box cardstyle ">
  ...
  <!-- piechart code -->
 <div class="container piecont">
   <div class="piechart">
    <div class="pie animate" style="--p:20;--c:red;"> 20%</div>
    <div class="pie animate" style="--p:40;--c:purple;"> 40%</div>
    <div class="pie animate" style="--p:60;--c:orange;"> 60%</div>
    <div class="pie animate" style="--p:90;--c:lightgreen;"> 90%</div>
    <div class="pie animate" style="--p:90;--c:teal;"> 90%</div>
  </div>
 </div>
